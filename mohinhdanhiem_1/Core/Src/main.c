...
/* USER CODE BEGIN PV */
DS18B20_Name DS1;
uint16_t Temp = 0;    // Nhiệt độ từ DS18B20
uint16_t Humidity = 0; // �?ộ ẩm đất
uint32_t delay_temp = 500;
uint32_t delay_soil = 500;

// UART variables
uint8_t data_rx;
uint8_t uart_buffer[100];
uint8_t start_flag = 0; // Flag to control UART transmission
/* USER CODE END PV */
