...
int main(void)
{
  ...
  osThreadDef(Task1, readTemp, osPriorityIdle, 0, 128);
  Task1Handle = osThreadCreate(osThread(Task1), NULL);

  /* definition and creation of Task3 */
  osThreadDef(Task3, Display_LCD_UART, osPriorityIdle, 0, 128);
...
/* USER CODE BEGIN Header_readHum */
/**
...
/* USER CODE BEGIN Header_Display_LCD_UART */
/**
...
void Display_LCD_UART(void const * argument)
{
  /* USER CODE BEGIN Display_LCD_UART */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
